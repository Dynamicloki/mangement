			...
			<div class="row"> 
				<div class="col-md-6 col-sm-6">
					...
					<div class="mb-3">
						...
						<div class="input-group">
							<input type="password" class="form-control" value="<?php echo $_SESSION["studentlogin"];?>" id="basic-url" aria-describedby="basic-addon3 basic-addon4" name="studentlogin" placeholder="Student Login Password">
						</div>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					...
					<div class="mb-3">
						...
						<div class="input-group">
								<input type="number" class="form-control" id="basic-url"  aria-describedby="basic-addon3 basic-addon4" value="<?php echo $_SESSION["fatherMobileNumber"];?>" name="fathermobilenumber" placeholder="father number">
						</div>
					</div>
					<div class="mb-3">
						  ...
						  <span class="right"> (optional and can leave blank)</span>
						<div class="input-group">
							<input type="number" class="form-control" value="<?php echo $_SESSION["motherMobileNumber"];?>" name="motherMobileNumber" id="basic-url" aria-describedby="basic-addon3 basic-addon4" placeholder="mother number">
						</div>
					</div>
					<div class="mb-3">
						  <label for="basic-url" class="form-label">Parents Mail Id </label>
						  <div class="input-group">
							<input type="text" class="form-control" value="<?php echo $_SESSION["parentsmail"];?>" id="basic-url" aria-describedby="basic-addon3 basic-addon4" name="parentsmail" placeholder="Parents MailId" >
						  </div>
					</div>
					<div class="mb-3">
					  <label for="basic-url" class="form-label">Parents Login Password <span class="third">(Atleast 6 characters)</span> </label>
					  <div class="input-group">
							<input type="text" class="form-control" value="<?php echo $_SESSION["parentsmailpassword"];?>" id="basic-url" aria-describedby="basic-addon3 basic-addon4" name="parentsmailpassword" placeholder="Parents Password" >
					  </div>
					</div>
					<div class="mb-3">
					  <label for="exampleFormControlTextarea1" class="form-label">Address</label>
					  <textarea class="form-control" name="address" value="<?php echo $_SESSION["address"];?>" id="exampleFormControlTextarea1" rows="3"></textarea>
					</div>
					<div class="mb-3">
